...
<head>
  ...
  <!-- SEO Tag -->
  <meta name="author" content="Munawir Fikri" />
  ...
  <link
    rel="preload"
    href="https://cdn.jsdelivr.net/npm/aos@2.3.4/dist/aos.js"
    integrity="sha256-pQBbLkFHcP1cy0C8IhoSdxlm0CtcH5yJ2ki9jjgR03c="
    crossorigin="anonymous"
    as="script" />
  <link
    rel="preload"
    href="https://cdn.jsdelivr.net/npm/canvas-confetti@1.9.2/dist/confetti.browser.js"
    integrity="sha256-mvTaORw+RTgKnX6ZHT4P5Sc9DNP2TBpSGII7F3sT8iE="
    crossorigin="anonymous"
    as="script" />
...
<body data-key="" data-url="" style="overflow-y: hidden">
  <!-- Navbar Bottom -->
  <nav
    class="navbar bg-dark navbar-expand fixed-bottom rounded-top-4 p-0"
    id="navbar-menu">
  ...
  <main
    ...
    <section id="home" class="position-relative overflow-hidden p-0 m-0">
      ...
      <div class="position-relative text-center pt-4 pb-0 px-0 m-0">
        ...
        <h2 style="font-size: 3rem">Vinni & Fikri</h2>
        <p class="mb-0" style="font-size: 1.5rem">Senin, 02 Desember 2024</p>

        <a
          class="btn btn-outline-light btn-sm shadow rounded-pill px-3 my-2"
          target="_blank"
          href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=The%20Wedding%20of%20Vinni%20and%20Fikri&details=The%20Wedding%20of%20Vinni%20and%20Fikri%20%7C%205%20Desember%202024&dates=20241201/20241201&location=https://maps.app.goo.gl/2qPufTxA4BhMwEUG8">
    ...
    <svg
      ...
      <path
        fill="currentColor"
        fill-opacity="1"
        d="M0,160L48,144C96,128,192,96,288,106.7C384,117,480,171,576,165.3C672,160,768,96,864,96C960,96,1056,160,1152,154.7C1248,149,1344,75,1392,37.3L1440,0L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
    </svg>
    ...
    <section class="dark-section bg-black" id="bride">
      <div class="text-center">
        ...
        <div class="position-relative">
          <div class="position-absolute" style="top: 0%; right: 10%">
            <svg
              ...
              fill="currentColor"
              class="opacity-50"
              onload="util.animate(this, 500, 'animate-love')"
              viewBox="0 0 16 16">
              <path
        ...
        <h2 class="font-esthetic py-4 px-2" style="font-size: 2rem">
        ...
        <div class="position-relative">
          <div class="position-absolute" style="top: 0%; left: 10%">
            <svg
              ...
              fill="currentColor"
              class="opacity-50"
              onload="util.animate(this, 2000, 'animate-love')"
              viewBox="0 0 16 16">
              <path
                d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15" />
            </svg>
        ...
        <div class="overflow-x-hidden">
          <div data-aos="fade-right" data-aos-duration="2000">
            ...
            <h2 style="font-size: 1.5rem">
              Vinniola Hijriani Nur Asy Syam, S.T
            </h2>
          ...
          <div class="position-relative">
            <div class="position-absolute" style="top: 0%; right: 10%">
              <svg
                ...
                fill="currentColor"
                class="opacity-50"
                onload="util.animate(this, 3000, 'animate-love')"
                viewBox="0 0 16 16">
                <path
                  d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15" />
              </svg>
          ...
          <div data-aos="fade-left" data-aos-duration="2000">
            ...
            <p class="mb-0">
              Bapak Dr. H. M. Rizal Akbar, S.Si, M.Phil &amp; Ibu Hj. Lestary
              Fitriany, S.T, M.E
            </p>
          </div>
        </div>
        ...
        <div class="position-relative">
          <div class="position-absolute" style="top: 0%; right: 5%">
            <svg
              ...
              fill="currentColor"
              class="opacity-50"
              onload="util.animate(this, 1500, 'animate-love')"
              viewBox="0 0 16 16">
              <path
                fill-rule="evenodd"
    ...
    <div class="container">
      <div class="text-center" data-aos="fade-up" data-aos-duration="2000">
        <h2 class="font-esthetic mt-0 mb-3" style="font-size: 2rem">
    ...
    <br><br>
    <div class="text-center">
      <h2 class="font-esthetic py-3" style="font-size: 2rem">
        Story
      </h2>
    </div>
    <div class="container">
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100 d-flex flex-column">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <p class="card-text">
                <b>2018</b> - Vinni dan Fikri pertama kali bertemu saat masa orientasi mahasiswa baru di Universitas Riau, Pekanbaru. Saat itu, belum ada benih cinta di antara mereka, tetapi keduanya sudah saling merasa perlu melindungi satu sama lain karena berasal dari daerah yang sama, yaitu Dumai.
              </p>
              <div class="mt-auto">
                <p class="card-text"><small class="text-muted">Lokasi: Fakultas Teknik, Universitas Riau</small></p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-md-4 mb-4">
          <div class="card h-100 d-flex flex-column">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <p class="card-text">
                <b>2020</b> - Pelik rasanya, cinta mereka tumbuh di tengah pandemi dan saat berlangsungnya Pemilihan Kepala Daerah Kota Dumai. Fikri memanfaatkan momen pilkada untuk belajar dan mengamati ilmu politik praktis, sementara Vinni selalu mendukung dan mendengarkan setiap cerita perjalanan Fikri. Hal ini membuat kedua insan ini memilih untuk membangun komunikasi yang lebih intens.
              </p>
              <div class="mt-auto">
                <p class="card-text"><small class="text-muted">Lokasi: Kota Dumai</small></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="position-relative">
      <div class="position-absolute" style="top: 0%; left: 5%">
        <svg
          ...
          fill="currentColor"
          class="opacity-50"
          onload="util.animate(this, 4000, 'animate-love')"
          viewBox="0 0 16 16">
          <path
            fill-rule="evenodd"
            d="m8 2.42-.717-.737c-1.13-1.161-3.243-.777-4.01.72-.35.685-.451 1.707.236 3.062C4.16 6.753 5.52 8.32 8 10.042c2.479-1.723 3.839-3.29 4.491-4.577.687-1.355.587-2.377.236-3.061-.767-1.498-2.88-1.882-4.01-.721zm-.49 8.5c-10.78-7.44-3-13.155.359-10.063q.068.062.132.129.065-.067.132-.129c3.36-3.092 11.137 2.624.357 10.063l.235.468a.25.25 0 1 1-.448.224l-.008-.017c.008.11.02.202.037.29.054.27.161.488.419 1.003.288.578.235 1.15.076 1.629-.157.469-.422.867-.588 1.115l-.004.007a.25.25 0 1 1-.416-.278c.168-.252.4-.6.533-1.003.133-.396.163-.824-.049-1.246l-.013-.028c-.24-.48-.38-.758-.448-1.102a3 3 0 0 1-.052-.45l-.04.08a.25.25 0 1 1-.447-.224l.235-.468ZM6.013 2.06c-.649-.18-1.483.083-1.85.798-.131.258-.245.689-.08 1.335.063.244.414.198.487-.043.21-.697.627-1.447 1.359-1.692.217-.073.304-.337.084-.398"></path>
        ...
        <div class="text-center">
          ...
          <div class="overflow-x-hidden">
            ...
            <div class="py-2" data-aos="fade-right" data-aos-duration="1500">
              ...
              <p>
                Senin, 02 Desember 2024 - Pukul 11:00 - Selesai (Kediaman
                Mempelai Wanita)
              </p>
            </div>
            ...
            <div class="py-2" data-aos="fade-up" data-aos-duration="1500">
              <a
                href="https://maps.app.goo.gl/2qPufTxA4BhMwEUG8"
                target="_blank"
            ...
            <div class="py-2" data-aos="fade-left" data-aos-duration="1500">
              ...
              <p>
                Kamis, 05 Desember 2024 - Pukul 11.00 WIB - Selesai (Kediaman
                Mempelai Pria)
              </p>
            </div>
          </div>
    ...
    <section class="dark-section bg-black" id="gallery">
      <div class="container pb-5 pt-4">
        <div class="card-body border rounded-5 shadow p-3">
          <h2
            class="font-esthetic text-center py-3"
            data-aos="fade-down"
    ...
    <div class="container">
      <div class="pb-2">
        <div class="text-center">
          <h2 class="font-esthetic mt-0 mb-3" style="font-size: 3rem">
            Love Gift
          </h2>
          ...
          <div class="overflow-x-hidden">
            <div class="row row-cols-2">
              <div
                class="col card-body border rounded-4 shadow p-3 mx-4 mt-2 mb-4"
                data-aos="fade-down"
                data-aos-duration="1500">
                <img
                ...
                <p class="card-text mt-3 mb-0" style="font-size: 0.9rem">
                  No. Rekening 7267498298
                </p>
                <p class="card-text" style="font-size: 0.9rem">
                  a.n VINNIOLA HIJRIANI NUR ASY SYAM
                </p>
                <!-- Ubah juga data-copy sesuai dengan no rekening -->
                <button
                  class="btn btn-outline-dark btn-sm rounded-4"
                  data-copy="7267498298"
                  onclick="util.copy(this, 'Tersalin')">
                  Salin No. Rekening
                </button>
              </div>
            </div>
    ...
    <section class="m-0 px-0 pb-0 pt-2" id="comment">
      <div class="container">
        <div class="card-body border rounded-4 shadow p-3">
          <h2 class="font-esthetic text-center mb-3" style="font-size: 3rem">
            Ucapan &amp; Doa
          </h2>
        ...
        <nav class="d-flex justify-content-center mb-0 pt-2">
          <ul class="pagination mb-0">
            <li class="page-item disabled" id="previous">
              <button
                class="page-link rounded-start-4"
                onclick="pagination.previous(this)">
    ...
    <div class="container">
      <div class="text-center">
        <p style="font-size: 0.9rem" class="pt-2 pb-1 px-2">
          ...
          Bapak/Ibu/Saudara/i berkenan untuk memberikan do'a restunya. Kami
          ucapkan terima kasih.
        </p>

        <h2 class="font-esthetic">
        ...
        <div
          ...
          <div class="col-auto">
            <small class="text-light"> Makeover by mun. </small>
          </div>
          <div class="col-auto">
            <small> Special thanks to Dewankl </small>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="loading-page bg-black" id="welcome" style="opacity: 1">
    <div
      ...
      <div class="text-center">
        <h2 class="font-esthetic mb-4" style="font-size: 2.5rem">
          The Wedding Of
        </h2>
        ...
        <div
          id="guest-name"
          data-message="Kepada Yth Bapak/Ibu/Saudara/i"></div>

        <button
          type="button"
          class="btn btn-light shadow rounded-4 mt-4"
          onclick="guest.open(this)">
  ...
  <button
    ...
    id="button-theme"
    style="display: none"
    class="btn bg-dark border border-2 btn-sm rounded-circle btn-theme"
  ...
  <?php
    $playlist = [
      ...
      "./assets/music/sound5.mp3",
  ];
  $random_key = array_rand($playlist);
  ?>
  ...
  <button
    ...
    id="button-music"
    style="display: none"
    class="btn bg-dark border border-2 btn-sm rounded-circle btn-music"
    onclick="audio.button(this)"
    data-status="true"
    data-url="<?= $playlist[$random_key]?>">
    ...
    <div
      ...
      <div class="w-75 text-center">
        ...
        <small
          ...
          id="progress-info"
          style="display: none">Loading</small>
        <noscript>
  ...
  <script
    ...
    crossorigin="anonymous"></script>
  <script
    src="https://cdn.jsdelivr.net/npm/canvas-confetti@1.9.2/dist/confetti.browser.js"
    integrity="sha256-mvTaORw+RTgKnX6ZHT4P5Sc9DNP2TBpSGII7F3sT8iE="
    crossorigin="anonymous"></script>
